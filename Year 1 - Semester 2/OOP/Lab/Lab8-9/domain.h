...
public:
	...
	*/
	TrenchCoat(const std::string& size, const std::string& colour, const int& price, const int& quantity, const std::string& photographLink);
	...
	*/
	...
	/*
	* Get the string representation of a TrenchCoat
	* Output:
	* 	return: a string, representing the TrenchCoat
	*/
	std::string toString();
...
public:
	...
	*/
	static bool isColourValid(const std::string& colour);
