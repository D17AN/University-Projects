...
public class ProgramOptionsController {
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("a", new IntType()),
                new CompStatement(new VarDeclarationStatement("b", new IntType()),
                        new CompStatement(new VarDeclarationStatement("c", new IntType()),
                                new CompStatement(new AssigStatement("a", new ValueExpression(new IntValue(1))),
                                        new CompStatement(new AssigStatement("b", new ValueExpression(new IntValue(2))),
                                                new CompStatement(new AssigStatement("c", new ValueExpression(new IntValue(5))),
                                                        new CompStatement(new SwitchStatement(
                                                                new ArithmExpression('*', new VariableExpression("a"), new ValueExpression(new IntValue(10))),
                                                                new ArithmExpression('*', new VariableExpression("b"), new VariableExpression("c")),
