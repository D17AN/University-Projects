    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("v", new IntType()),
                new CompStatement(new AssigStatement("v", new ValueExpression(new IntValue(0))),
                        new CompStatement(new WhileStatement(new RelationalExpression("<", new VariableExpression("v"), new ValueExpression(new IntValue(3))),
                                new CompStatement(new ForkStatement(new CompStatement(new PrintStatement(new VariableExpression("v")),
                                        new AssigStatement("v", new ArithmExpression('+', new VariableExpression("v"), new ValueExpression(new IntValue(1)))))),
                                        new AssigStatement("v", new ArithmExpression('+', new VariableExpression("v"), new ValueExpression(new IntValue(1)))))),
                                new CompStatement(new SleepStatement(5), new PrintStatement(new ArithmExpression('*', new VariableExpression("v"), new ValueExpression(new IntValue(10))))))));
        allStmts.add(ex11);
