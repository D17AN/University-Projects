...
public class ProgramOptionsController {
        ...
        if(selectedStm == null){
            ...
            try{
                ...
                ProgramState programState = new ProgramState(new ADTStack<>(), new ADTDictionary<>(), new ADTList<>(),
                        new ADTDictionary<>(), new ADTHeap(), selectedStm);
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("v", new IntType()),
                new CompStatement(new VarDeclarationStatement("x", new IntType()),
                        new CompStatement(new VarDeclarationStatement("y", new IntType()),
                                new CompStatement(new AssigStatement("v", new ValueExpression(new IntValue(0))),
                                        new CompStatement(new RepeatUntilStatement(
                                                new CompStatement(new ForkStatement(new CompStatement(new PrintStatement(new VariableExpression("v")),
                                                        new AssigStatement("v", new ArithmExpression('-', new ValueExpression(new IntValue(1)), new VariableExpression("v"))))),
                                                        new AssigStatement("v", new ArithmExpression('+', new ValueExpression(new IntValue(1)),  new VariableExpression("v")))),
                                                new RelationalExpression("==", new VariableExpression("v"), new ValueExpression(new IntValue(3)))
                                        ),
                                                new CompStatement(new AssigStatement("x", new ValueExpression(new IntValue(1))),
                                                        new CompStatement(new NopStatement(),
                                                                new CompStatement(new AssigStatement("y", new ValueExpression(new IntValue(3))),
                                                                        new CompStatement(new NopStatement(),
                                                                                new PrintStatement(new ArithmExpression('*', new ValueExpression(new IntValue(10)), new VariableExpression("v")))))))
                                        )))));
        allStmts.add(ex11);
