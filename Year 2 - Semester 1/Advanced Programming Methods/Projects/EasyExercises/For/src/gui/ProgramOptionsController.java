...
public class ProgramOptionsController {
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("v", new IntType()),
                new CompStatement(new AssigStatement("v", new ValueExpression(new IntValue(20))),
                        new CompStatement(new ForStatement("v", new ValueExpression(new IntValue(0)),
                                new ValueExpression(new IntValue(3)),
                                new ArithmExpression('+', new VariableExpression("v"), new ValueExpression(new IntValue(1))),
                                ...
                                new PrintStatement(new ArithmExpression('*', new VariableExpression("v"), new ValueExpression(new IntValue(10)))))));
        allStmts.add(ex11);
