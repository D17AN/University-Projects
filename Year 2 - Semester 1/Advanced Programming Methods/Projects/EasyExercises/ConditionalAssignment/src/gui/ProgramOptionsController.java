...
public class ProgramOptionsController {
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("a", new RefType(new IntType())),
                new CompStatement(new VarDeclarationStatement("b", new RefType(new IntType())),
                        new CompStatement(new VarDeclarationStatement("v", new IntType()),
                                new CompStatement(new NewStatement("a", new ValueExpression(new IntValue(0))),
                                        new CompStatement(new NewStatement("b", new ValueExpression(new IntValue(0))),
                                                new CompStatement(new WriteHeapStatement("a", new ValueExpression(new IntValue(1))),
                                                        new CompStatement(new WriteHeapStatement("b", new ValueExpression(new IntValue(2))),
                                                                new CompStatement(new ConditionalAssignmentStatement("v", new RelationalExpression("<",
                                                                        ...
                                                                        new CompStatement(new PrintStatement(new VariableExpression("v")),
                                                                                new CompStatement(new ConditionalAssignmentStatement("v",
                                                                                        new RelationalExpression(">",new ArithmExpression('-', new ValueExpression(new IntValue(2)), new ReadHeapExpression(new VariableExpression("b"))),
                                                                                                new ReadHeapExpression(new VariableExpression("a"))),
                                                                                        new ValueExpression(new IntValue(100)),
                                                                                        new ValueExpression(new IntValue(200))),
                                                                                        new PrintStatement(new VariableExpression("v"))))))))))));
