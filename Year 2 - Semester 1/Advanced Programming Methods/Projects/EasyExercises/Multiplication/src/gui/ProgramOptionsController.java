...
public class ProgramOptionsController {
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("v1", new IntType()),
                new CompStatement(new VarDeclarationStatement("v2", new IntType()),
                        new CompStatement(new AssigStatement("v1", new ValueExpression(new IntValue(3))),
                                new CompStatement(new AssigStatement("v2", new ValueExpression(new IntValue(4))),
