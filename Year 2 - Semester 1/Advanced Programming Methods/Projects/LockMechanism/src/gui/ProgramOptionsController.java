...
import domain.utils.ADTLockTable.ADTLockTable;
...
public class ProgramOptionsController {
        ...
        if(selectedStm == null){
            ...
            try{
                ...
                ProgramState programState = new ProgramState(new ADTStack<>(), new ADTDictionary<>(), new ADTList<>(),
                        new ADTDictionary<>(), new ADTHeap(), new ADTLockTable(), selectedStm);
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(new VarDeclarationStatement("v1", new RefType(new IntType())),
                new CompStatement(new VarDeclarationStatement("v2", new RefType(new IntType())),
                        new CompStatement(new VarDeclarationStatement("x", new IntType()),
                                new CompStatement(new VarDeclarationStatement("q", new IntType()),
                                        new CompStatement(new NewStatement("v1", new ValueExpression(new IntValue(20))),
                                                new CompStatement(new NewStatement("v2", new ValueExpression(new IntValue(30))),
                                                        new CompStatement(new NewLockStatement("x"),
                                                                new CompStatement(new ForkStatement(
                                                                        new CompStatement(new ForkStatement(
                                                                                new CompStatement(new LockStatement("x"),
                                                                                        new CompStatement(new WriteHeapStatement("v1", new ArithmExpression('-', new ValueExpression(new IntValue(1)), new ReadHeapExpression(new VariableExpression("v1")))),
                                                                                                new UnlockStatement("x")))
                                                                        ),
                                                                                new CompStatement(new LockStatement("x"),
                                                                                        new CompStatement(new WriteHeapStatement("v1", new ArithmExpression('*', new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))),
                                                                                                new UnlockStatement("x"))))
                                                                ),
                                                                        new CompStatement( new NewLockStatement("q"),
                                                                                new CompStatement(new ForkStatement(
                                                                                        new CompStatement( new ForkStatement(
                                                                                                new CompStatement(new LockStatement("q"),
                                                                                                        new CompStatement(new WriteHeapStatement("v2", new ArithmExpression('+', new ReadHeapExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(5)))),
                                                                                                                new UnlockStatement("q")))
                                                                                        ),
                                                                                                new CompStatement(new LockStatement("q"),
                                                                                                        new CompStatement(new WriteHeapStatement("v2", new ArithmExpression('*', new ReadHeapExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(10)))),
                                                                                                                new UnlockStatement("q"))))
                                                                                ),
                                                                                                                ...
                                                                                                                new CompStatement(new NopStatement(),
                                                                                                                        new CompStatement(new LockStatement("x"),
                                                                                                                                new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                                                                        new CompStatement(new UnlockStatement("x"),
                                                                                                                                                new CompStatement(new LockStatement("q"),
