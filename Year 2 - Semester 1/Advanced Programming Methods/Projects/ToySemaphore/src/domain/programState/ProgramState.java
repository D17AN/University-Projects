...
public class ProgramState {
    ...
    private ADTToySemaphoreTableInterface toySemaphoreTable;
    ...
    public ProgramState(ADTStackInterface<StatementInterface> stk, ADTDictionaryInterface<String,
            ValueInterface> symtbl, ADTListInterface<ValueInterface> ot,
                        ...
                        ADTToySemaphoreTableInterface toySemaphoreTable,
    ...
    public void setToySemaphoreTable(ADTToySemaphoreTableInterface toySemaphoreTable) {
        this.toySemaphoreTable = toySemaphoreTable;
    }
    ...
    public ADTToySemaphoreTableInterface getToySemaphoreTable() {
    ...
    public String toySemaphoreTableToString() throws ToyLanguageException {
