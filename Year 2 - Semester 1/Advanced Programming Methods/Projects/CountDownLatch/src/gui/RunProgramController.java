...
public class RunProgramController {
    ...
    @FXML
    private TableView<Pair<Integer, Integer>> latchTableView;//here

    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> latchLocationColumn;//here

    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> latchValueColumn;//here
    @FXML
    ...
    public void initialize(){
        ...
        latchLocationColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().first).asObject());//here
        latchValueColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().second).asObject());//here
    }
    ...
    private void populate(){
        ...
        this.populateLatchTableView();//here
    }
    ...
    private void populateLatchTableView(){
        ...
        ADTLatchTableInterface latchTable = Objects.requireNonNull(programState).getLatchTable();
        ...
        this.latchTableView.setItems(FXCollections.observableArrayList(latchTableEntries));
    }
