        ...
        if(selectedStm == null){
            ...
            try{
                ...
                ProgramState programState = new ProgramState(new ADTStack<>(), new ADTDictionary<>(), new ADTList<>(),
                        new ADTDictionary<>(), new ADTHeap(), new ADTLatchTable(), selectedStm);
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex11 = new CompStatement(
                ...
                new CompStatement(
                        ...
                        new CompStatement(
                                new VarDeclarationStatement("v3", new RefType(new IntType())),
                                new CompStatement(
                                                                                        ...
                                                                                        new CompStatement(
                                                                                                ...
                                                                                                new CompStatement(
                                                                                                        ...
                                                                                                        new CompStatement(
                                                                                                                ...
                                                                                                                new ForkStatement(
                                                                                                                        new CompStatement(
                                                                                                                                new WriteHeapStatement("v2", new ArithmExpression('*', new ReadHeapExpression(new VariableExpression("v2")), new ValueExpression(new IntValue(10)))),
                                                                                                                                new CompStatement(
                                                                                                                                        ...
                                                                                                                                        new CompStatement(
                                                                                                                                                ...
                                                                                                                                                new ForkStatement(
                                                                                                                                                        new CompStatement(
                                                                                                                                                                new WriteHeapStatement("v3", new ArithmExpression('*', new ReadHeapExpression(new VariableExpression("v3")), new ValueExpression(new IntValue(10)))),
                                                                                                                                                                new CompStatement(
