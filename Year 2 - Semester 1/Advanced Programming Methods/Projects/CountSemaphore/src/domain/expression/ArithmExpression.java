...
public class ArithmExpression implements ExpressionInterface{
    ...
    public ArithmExpression(char op, ExpressionInterface exp1, ExpressionInterface exp2){
        this.exp1 = exp1;
        this.exp2 = exp2;
        this.operation = op;
    }
    ...
    public ExpressionInterface clone(){
        return new ArithmExpression(this.operation, this.exp1.clone(), this.exp2.clone());
    }
