...
import domain.utils.ADTSemaphoreTable.ADTSemaphoreTable;
        ...
        if(selectedStm == null){
            ...
            try{
                ...
                ProgramState programState = new ProgramState(new ADTStack<>(), new ADTDictionary<>(), new ADTList<>(),
                        new ADTDictionary<>(), new ADTHeap(), new ADTSemaphoreTable(), selectedStm);
    ...
    private ObservableList<StatementInterface> getAllStatements(){
        ...
        StatementInterface ex2 = new CompStatement(new VarDeclarationStatement("a", new IntType()),
                new CompStatement(new VarDeclarationStatement("b", new IntType()),
                        new CompStatement(new AssigStatement("a", new ArithmExpression('+', new
                                ArithmExpression('*', new ValueExpression(new IntValue(3)), new ValueExpression(new IntValue(5))), new ValueExpression(new IntValue(2)))),
                                new CompStatement(new AssigStatement("b", new ArithmExpression('+', new ValueExpression(new
                                        IntValue(1)), new VariableExpression("a"))), new PrintStatement(new VariableExpression("b"))))));
        allStmts.add(ex2);
        ...
        StatementInterface ex6 = new CompStatement(new VarDeclarationStatement("v", new IntType()),
                new CompStatement(new AssigStatement("v", new ValueExpression(new IntValue(4))),
                        new CompStatement(new WhileStatement(new RelationalExpression(">", new VariableExpression("v"), new ValueExpression(new IntValue(0))),
                                new CompStatement(new PrintStatement(new VariableExpression("v")), new AssigStatement("v", new ArithmExpression('-', new ValueExpression(new IntValue(1)), new VariableExpression("v"))))),
                                new PrintStatement(new VariableExpression("v")))));
        allStmts.add(ex6);
                        ...
                        new CompStatement(new VarDeclarationStatement("a", new RefType(new RefType(new IntType()))),
                                new CompStatement(new NewStatement("a", new VariableExpression("v")),
                                        new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v"))),
                                                new PrintStatement(new ArithmExpression('+', new ValueExpression(new IntValue(5)), new ReadHeapExpression(new ReadHeapExpression(new VariableExpression("a"))))))))));
        allStmts.add(ex8);
                ...
                new CompStatement(new NewStatement("v", new ValueExpression(new IntValue(20))),
                        new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v"))),
                                new CompStatement(new WriteHeapStatement("v", new ValueExpression(new IntValue(30))),
                                        new PrintStatement(new ArithmExpression('+', new ValueExpression(new IntValue(5)), new ReadHeapExpression(new VariableExpression("v"))))))));
        allStmts.add(ex9);
                                        ...
                                        new CompStatement(
                                                new ForkStatement(
                                                        new CompStatement(
                                                                ...
                                                                new CompStatement(
                                                                        new WriteHeapStatement("v1", new ArithmExpression('*', new ValueExpression(new IntValue(10)), new ReadHeapExpression(new VariableExpression("v1")))),
                                                                        new CompStatement(
                                                        ...
                                                        new ForkStatement(
                                                                new CompStatement(
                                                                        ...
                                                                        new CompStatement(
                                                                                new WriteHeapStatement("v1", new ArithmExpression('*', new ValueExpression(new IntValue(10)), new ReadHeapExpression(new VariableExpression("v1")))),
                                                                                new CompStatement(
                                                                                        new WriteHeapStatement("v1", new ArithmExpression('*', new ValueExpression(new IntValue(2)), new ReadHeapExpression(new VariableExpression("v1")))),
                                                                                        new CompStatement(
                                                                                                new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                                new ReleaseStatement("cnt")
                                                                                        )
