...
import domain.utils.ADTBarrierTable.ADTBarrierTable;
        ...
        if(selectedStm == null){
            ...
            try{
                ...
                ProgramState programState = new ProgramState(new ADTStack<>(), new ADTDictionary<>(), new ADTList<>(),
                        new ADTDictionary<>(), new ADTHeap(), new ADTBarrierTable(), selectedStm);
                                                                                ...
                                                                                new CompStatement(
                                                                                        new ForkStatement(
                                                                                                new CompStatement(
                                                                                                        new AwaitStatement("cnt"),
                                                                                                        new CompStatement(
                                                                                                                new WriteHeapStatement("v2", new ArithmExpression('*', new ValueExpression(new IntValue(10)), new ReadHeapExpression(new VariableExpression("v2")))),
                                                                                                                new CompStatement(
                                                                                                                        new WriteHeapStatement("v2", new ArithmExpression('*', new ValueExpression(new IntValue(10)), new ReadHeapExpression(new VariableExpression("v2")))),
