...
public class RunProgramController {
    ...
    private void populateBarrierTableView() {
        ...
        ADTBarrierTableInterface barrierTable = Objects.requireNonNull(programState).getBarrierTable();
        List<Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>>> barrierList = new ArrayList<>();
        for (Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>> entry: barrierTable.getBarrierTableHostagesFromBasement().entrySet()) {
